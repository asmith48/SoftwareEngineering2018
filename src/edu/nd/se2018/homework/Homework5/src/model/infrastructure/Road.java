...
public class Road {
	...
	public Road(String name, Point start, Point end, Direction direction, boolean buildCarFactory, boolean clearEnds){
		roadName = name;
		startX = start.x;
		startY = start.y;
		endX = end.x;
	...
	public void addCarFactory(){
		if (carFactory == null) // We only allow one
			if (direction==Direction.SOUTH)
				...
				carFactory = new CarFactory(direction, new Point(endX,startY-roadSize/2), gates);
			}
	}
